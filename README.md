...
- node.js >= 18
- [opencode](https://github.com/opencode-ai/opencode) installed and configured (`~/.config/opencode/opencode.json`)
- (optional) [gh cli](https://cli.github.com/) authenticated for github sync
